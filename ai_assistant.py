...
def get_bro_response(user_message, current_money):
    ...
    system_prompt = (
        ...
        "Твои задачи: "
        "1. Оценка трат: Сравни стоимость покупки со СВОБОДНЫМ ЛИМИТОМ. Если стоимость больше лимита — жестко ЗАПРЕТИ. Если меньше — РАЗРЕШИ, но напомни, сколько останется. "
        ...
        "Алгоритм ответа: Вердикт капсом (РАЗРЕШАЮ / НЕ СОВЕТУЮ / ЗАПРЕЩАЮ) и краткое дерзкое обоснование. "
